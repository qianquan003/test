 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://webServiceDemo.xi.com/", wsdlLocation = "http://localhost:9001/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://webServiceDemo.xi.com/", "ServiceHelloService");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://webServiceDemo.xi.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webServiceDemo.xi.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
