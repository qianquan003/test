 ...
 * generated in the com.xi.axis2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://webServiceDemo.xi.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://webServiceDemo.xi.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xi.axis2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webServiceDemo.xi.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webServiceDemo.xi.com/", name = "getValue")
